...
from services.nexus.ai.outreach_ai import (
    generate_pitch as _ai_generate_pitch,
    generate_visit_plan as _ai_generate_visit_plan,
)
...
def generate_visit_plan(
    ...
    """
    return _ai_generate_visit_plan(
        targets=targets,
        region=region,
        industry=industry,
        case_studies=case_studies,
